(function ($) {
  ...
  $(document).on("click", ".open-project", function () {
    ...
    $.getJSON(
      "https://portfolio-57e5b-default-rtdb.firebaseio.com/proyectos.json",
      function (data) {
        $(".content-blocks.pop section").html(
          '<div class="load-data">' +
            '<div class="block-content">' +
              //Inicio proyecto
              '<div class="project-head">' +
                '<h1 class="block-title">'+data[projectUrl].titulo+'</h1>' +
                '<div class="tags"><span>Category : </span>'+data[projectUrl].categoria+'</div>' +
                '<p class="project-description">'+data[projectUrl].descripcion+'</p>' +

                //  Inicio proyecto media
                '<div class="project-media row text-center">' +
                  '<div class="col-md-12">' +
                    '<img src="'+data[projectUrl].img+'">' +
                  '</div>' +
                '</div>' +
                //  FIN proyecto media
                //Correo
                '<div class="row text-center">'+
                  '<div class="col-md-12 btn-email">'+
                    ' <a class="btn lowercase">silvatarikt@outlook.com</a>'+
                  '</div>' +
                '</div>' +
              '</div>' +
              //FIN proyecto
